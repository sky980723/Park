...
import com.text.park.unit.SpringContextUtils;
...
public class DataConfig {
    ...
    public SqlSessionFactoryBean mybatisSqlSession() throws Exception {
        ...
        ssfb.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath*:com/ola/qh/**/mapper/*Mapper" +
                ".xml"));
        return ssfb;
    }
   ...
   /* @Bean
    ...
    /*
     * @Bean public PlatformTransactionManager transactionManager() throws IOException{ return new DataSourceTransactionManager
     * (dataSource()); }
     */
    // 通过beanid获取实例
    @Bean
